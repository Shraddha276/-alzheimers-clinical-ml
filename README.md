...
Alzheimer’s disease using demographic and cognitive assessment variables

from the OASIS-1 dataset.
...
Raw data are not included due to data use restrictions.
